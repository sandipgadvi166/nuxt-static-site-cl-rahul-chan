<template lang="">
    <b-tab no-body title="Exide">
                        <div class="pa-5 mb-5 mx-auto">
                            <b-row class="exide p-3">
                               
                                <b-col class="mt-5" sm="12" md="4" lg="4">
                                <div>
                                    <b-card
                          ...
                          <a href="tel:919890038245">
                            ...
                            <a href="smstext://Automotive enquery">
                                ...
                                <div>
                                    ...
                                    img-src="~/static/product_photos/industrial.svg"
                                    img-alt="Image"
                                    img-top
                                    tag="article"
                                   no-body
                                ...
                                <div>
                                    <b-card
                                    no-body
                                    img-src="~/static/product_photos/homeups.svg"
                                    img-alt="Image"
                                    img-top
                                    tag="article"
